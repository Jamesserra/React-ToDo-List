    ...
    render() {
        ...
        return (
            <div className="row mb-1">
                ...
                <input 
                className="d-inline-block mt-2 ml-1"
                type="checkbox"
...
class ToDoList extends React.Component {
    ...
    toggleComplete(id, completed) {
        ...
        fetch(`https://altcademy-to-do-list-api.herokuapp.com/tasks/${id}/mark_${newState}?api_key=217`, {
            method: "PUT",
            mode: "cors",
        }).then(checkStatus)
        .then(json)
    ...
    deleteTask(id) {
        ...
        fetch(`https://altcademy-to-do-list-api.herokuapp.com/tasks/${id}?api_key=217`, {
            method: "DELETE",
            mode: "cors",
        }).then(checkStatus)
        .then(json)
    ...
    fetchTasks() {
      fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=217")
        .then(checkStatus)
        .then(json)
        .then((response) => {
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h2 className="mb-3 mt-3 text-center">To Do List</h2>
